...
namespace GurmansBookStores.DataAccess.Repository
{
    public class SP_Call : ISP_Call
    {
        ...
        public T OneRecord<T>(string procedurename, DynamicParameters param = null)
        {
            using (System.Data.SqlClient.SqlConnection sqlCon = new System.Data.SqlClient.SqlConnection(ConnectionString))
            {
                var value = System.Data.SqlClient.SqlConnection.Query<T>(procedureName, param, commandType: System.Data.CommandType.StoredProcedure);
        ...
        public T Single<T>(string procedurename, DynamicParameters param = null)
        {
            ...
            return (T)Convert.ChangeType(System.Data.SqlClient.SqlConnection.ExecuteScalar<T>(procedurename, param, commandType: System.Data.CommandType.StoredProcedure), typeof(T));
        }
    }
}
